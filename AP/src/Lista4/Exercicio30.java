/*
 * Dada uma matriz de tamanho N x M e um vetor de N elementos, fazer um programa
 * que preencha cada coluna da matriz com os elementos do vetor.
 */
package Lista4;
...
public class Exercicio30 {
    ...
    public static void main(String[] args) {
        ...
        int vetor[]=Exercicio1.vetor(linha);
